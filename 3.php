    ...
    <div class="container-fluid tm-container-content tm-mt-60">
        ...
        <div class="row tm-mb-90">
            <div class="col-12 d-flex justify-content-between align-items-center tm-paging-col">
                <a href="2.php" class="btn btn-primary tm-btn-prev mb-2 disabled">Previous</a>
                <div class="tm-paging d-flex">
                    <a href="index.php" class="tm-paging-link">1</a>
                    <a href="2.php" class="tm-paging-link">2</a>
                    <a href="3.php" class="active tm-paging-link">3</a>
                    <a href="4.php" class="tm-paging-link">4</a>
                </div>
                <a href="4.php" class="btn btn-primary tm-btn-next">Next Page</a>
            </div>            
        </div>
