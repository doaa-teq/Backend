                      ...
                      <tbody>
                        ...
                        try{
                            ...
                            foreach($DATA as $row){
                                echo"<tr>
                                <td>{$row['tag_name']}</td>
                                <td><a href='editCategory.php'><img src='./images/edit.png' alt='Edit' name='edit'></a></td>
                                <td><a href='deleteCategory.php'><img src='./images/delete.png' alt='Delete' name='delete'></a></td>
                              </tr>";
                            }
                            echo "</table>";
                        }catch(Exception $D){
